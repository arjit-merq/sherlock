...
export const CASES: CaseStudy[] = [
  {
    ...
    checks: [
      { system: "Airflow", finding: "Task skipped 31 Aug" },
      { system: "S3", finding: "File present, unread" },
      { system: "Manifests", finding: "Wrong date expected" },
      { system: "DataAPI", finding: "No curve returned" },
      { system: "SecAPI", finding: "Curve missing" },
      { system: "Jira", finding: "Prior case reasoning" },
      { system: "Source code", finding: "Date logic found" },
    ],
    contribution: [
